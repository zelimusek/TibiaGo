...
assert.match(serviceWorkerSource, /tibiago-static-v16/);
...
assert.match(html, /mobile\.css\?v=20260730\.5/);
assert.match(html, /screen-element\.css\?v=20260729\.4/);
assert.match(html, /launcher\.js\?v=20260730\.5/);
assert.match(html, /service-worker\.js\?v=16/);

const launcherSource = fs.readFileSync(
  path.join(__dirname, "..", "client", "src", "launcher.js"),
  "utf8"
);
assert.match(launcherSource, /CLIENT_BUILD\s*=\s*"20260730\.5"/);
